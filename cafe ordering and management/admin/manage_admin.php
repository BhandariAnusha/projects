        ...
        <div class="main-content">
            ...
            <div class="wrapper">
               ...
               <table class="tbl_full">
                  ...
                  <?php
                     $sql = "SELECT * FROM tbl_admin"; //query get admin table
                     ...
                     if($res)
                     {
                      ...
                      if($res || mysqli_num_rows($res)>0)
                      {
                        ...
                        {
                          //using while loop we get all the data from db
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo SITEURL; ?>admin/delete_admin.php?id=<?php echo $id; ?>" class="btn-tertary">Delete Admin</a>
                      </td>
                    </tr>
